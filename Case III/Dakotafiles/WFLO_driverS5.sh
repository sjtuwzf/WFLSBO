...
awk 'END { print $NF }'  ~/wzf/MSMD_add/S5/postProcessing/totalpower/0/volRegion.dat > ~/wzf/MSMD_add/AEP/S5_1.dat;
...
mpirun -np 60 renumberMesh -overwrite -parallel;
mpirun -np 60 actuatorDiskExplicitForceSimpleFoam -parallel;
awk 'END { print $NF }'  ~/wzf/MSMD_add/S5/postProcessing/totalpower/0/volRegion.dat > ~/wzf/MSMD_add/AEP/S5_2.dat;

sed -i 's/11.0/10.0/g' 0/U;
sed -i 's/11.0/10.0/g' 0/include/initialConditions;
