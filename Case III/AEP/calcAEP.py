...
f = open('S5_1.dat', encoding='utf-8')
line = f.readline().strip()
power [4] =line

f = open('S5_2.dat', encoding='utf-8')
line = f.readline().strip()
power [5] =line

f = open('S6_1.dat', encoding='utf-8')
line = f.readline().strip()
power [6] =line

f = open('S6_2.dat', encoding='utf-8')
line = f.readline().strip()
power [7] =line

f = open('S7_1.dat', encoding='utf-8')
line = f.readline().strip()
power [8] =line

f = open('S7_2.dat', encoding='utf-8')
line = f.readline().strip()
power [9] =line

f = open('S7_3.dat', encoding='utf-8')
line = f.readline().strip()
power [10] =line

f = open('S8_1.dat', encoding='utf-8')
line = f.readline().strip()
power [11] =line

f = open('S8_2.dat', encoding='utf-8')
line = f.readline().strip()
power [12] =line
